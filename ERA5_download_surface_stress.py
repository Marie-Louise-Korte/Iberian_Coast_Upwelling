...
def download_data(year, month, variable):
    ...
    if year in YEARS[1:-1]:
        ...
        if variable == "mean_northward_turbulent_surface_stress":
            c.download(result, [f"../Data.nosync/ERA5/Surface_stress/Turbulent_mean/N_{year}_{int(month):02d}.nc"]) 
            print(f"N_{year}_{int(month):02d}")
        else:
            c.download(result, [f"../Data.nosync/ERA5/Surface_stress/Turbulent_mean/E_{year}_{int(month):02d}.nc"])
    ...
    if year == "1981":
        ...
        if variable == "mean_northward_turbulent_surface_stress":
            c.download(result, [f"../Data.nosync/ERA5/Surface_stress/Turbulent_mean/N_1981_12.nc"]) 
            print(f"N_1981_12")
        else:
            c.download(result, [f"../Data.nosync/ERA5/Surface_stress/Turbulent_mean/E_1981_12.nc"])
            print(f"E_1981_12")
    ...
    if year == "2024":
        ...
        if variable == "mean_northward_turbulent_surface_stress":
            c.download(result, [f"../Data.nosync/ERA5/Surface_stress/Turbulent_mean/N_2024_01.nc"]) 
            print(f"N_2024_01")
        else:
            c.download(result, [f"../Data.nosync/ERA5/Surface_stress/Turbulent_mean/E_2024_01.nc"])
            print(f"E_2024_01")
